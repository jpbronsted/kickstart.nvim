...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader><leader>', builtin.find_files, { desc = '[ ] Live Find' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>af', vim.lsp.buf.code_action, '[A]ction [F]ix', { 'n', 'x' })
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        python = { 'ruff_format' },
        ['SConstruct'] = { 'ruff_format' },
        ['SConscript'] = { 'ruff_format' },
        -- starlark = {},
        -- ["*.idl"] = {},
      },
    },
